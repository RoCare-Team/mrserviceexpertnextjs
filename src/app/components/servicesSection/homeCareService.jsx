...
function HomeCareService() {
    ...
    const Services = [
        ...
        { id: 6, name: 'House Painting', image: "/assets/HomeCare/PAINTER.webp", info: 'Keep your food fresh and beverages cool with our energy-efficient refrigerators, designed with advanced cooling technology and spacious interiors.',link:"home-deep-cleaning-service" },
