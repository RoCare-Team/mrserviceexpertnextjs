        ...
        <div className='common-spacing'>
            ...
            <div className="hero-section flex items-center  justify-around">
                <div className="leftHeroPortion w-7/12 py-2.5 flex items-center justify-end">
                    <img src="/assets/images/BannerImg.webp" alt="Our Services" width={600} height='auto' />
                </div>
                <div className="rightHeroDetails w-5/12 flex flex-col items-start justify-between  pl-2 pr-2">
                    ...
                    <div className='heroContact'>
                        <span><a href="tel:+91 9311587744"><button className='book-btn-style'>Call Now</button></a> for reliable home appliance care that protects what matters most  </span>
                    </div>
                </div>
            </div>
            ...
            <div className=' serviceBannerSection'>
                <img src="assets/images/home-appliaces.webp" alt='home-appliances' className='serviceBanner'  height="auto" width={1314} />
            </div>
            ...
            <div className="chooseUs p-4">
                ...
                <div className='flex justify-center items-start'>
                    ...
                    <span><img src="assets/images/star.webp" alt="choose us" className='w-10'  width="40px" height="auto" /></span>
                </div>
